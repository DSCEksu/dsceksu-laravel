...
<head>
  ...
  <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.2.0/css/all.css" integrity="sha384-hWVjflwFxL6sNzntih27bfxkr27PmbbK/iSvJ+a4+0owXq79v+lsFkW54bOGbiDQ" crossorigin="anonymous">
	...
	<style type="text/css" media="screen">
		[style*="SSP"] { font-family: "Google Sans", sans-serif !important }
		/* Linked Styles */
		body { padding:0 !important; margin:0 !important; display:block !important; min-width:100% !important; width:100% !important; background:#fff; color: #637282; -webkit-text-size-adjust:none }
		a { color:#2F5BE7; text-decoration:underline }
		p { padding:0 !important; margin:0 !important }
		img { -ms-interpolation-mode: bicubic; }

		/* Mobile styles */
		@media only screen and (max-device-width: 480px), only screen and (max-width: 480px) {
			div[class='mobile-br-1'] { height: 1px !important; display: block !important; background: #fafafa !important; }
													...
													<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#4a4a44">
														<tr>
															<td class="img" style="font-size:0pt; line-height:0pt; text-align:left" width="5" valign="top">
																<img src="{{ config('app.url') }}/images/email/section_red_corner_tl.jpg" border="0" width="5" height="9" alt="" />
															</td>
															<td valign="top">
																<div style="font-size:0pt; line-height:0pt; height:4px; background:#ef5751; "><img src="{{ config('app.url') }}/images/email/spacer.gif" width="1" height="4" style="height:4px" alt="" /></div>

															</td>
															<td class="img-right" style="font-size:0pt; line-height:0pt; text-align:right" width="5" valign="top">
																<img src="{{ config('app.url') }}/images/email/section_red_corner_tr.jpg" border="0" width="5" height="9" alt="" />
															</td>
														</tr>
													</table>
																				...
																				<tr>
																					<td align="right">
																						<table border="0" cellspacing="0" cellpadding="0" class="center">
																							<tr>
																								<td class="img" style="font-size:0pt; line-height:0pt; text-align:left" width="28"><a href="{{ config('app.social.github') }}" target="_blank"><i class="fab fa-github"></i></a></td>
																								<td class="img" style="font-size:0pt; line-height:0pt; text-align:left" width="28"><a href="{{ config('app.social.facebook') }}" target="_blank"><i class="fab fa-twitter"></i></a></td>
																								<td class="img" style="font-size:0pt; line-height:0pt; text-align:left" width="28"><a href="https://www.youtube.com/user/GoogleDevelopers" target="_blank"><i class="fab fa-youtube"></i></a></td>
																							</tr>
																						</table>
																					</td>
																				</tr>
															...
															<th class="column" style="font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal; Margin:0" width="276" valign="top">
																<table width="100%" border="0" cellspacing="0" cellpadding="0">
																	<tr>
																		<td>
																			<!-- Footer Copyright -->
																			<div class="text-footer" style="color:#a0a09a; font-family:'Google Sans', sans-serif; font-size:12px; line-height:16px; text-align:left">Copyright &copy; {{ date('Y') }} {{ config('app.name') }}</div>
																...
																<table width="100%" border="0" cellspacing="0" cellpadding="0">
																	<tr>
																		<td>
																			...
																			<div class="text-footer-r" style="color:#a0a09a; font-family:'Google Sans', sans-serif; font-size:12px; line-height:16px; text-align:right">
																				{{ config('app.info.location') }}
																			</div>
																			...
																			<div class="text-footer-r" style="color:#a0a09a; font-family:'Google Sans', sans-serif; font-size:12px; line-height:16px; text-align:right">
																				<a href="#" target="_blank" class="link-orange-u" style="color:#ee7550; text-decoration:underline"><span class="link-orange-u" style="color:#ee7550; text-decoration:underline">{{ config('app.url') }}</span></a> &nbsp; &nbsp; <a href="#" target="_blank" class="link-orange-u" style="color:#ee7550; text-decoration:underline"><span class="link-orange-u" style="color:#ee7550; text-decoration:underline">{{ config('app.info.email') }}</span></a>
																			</div>
																			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="spacer" style="font-size:0pt; line-height:0pt; text-align:center; width:100%; min-width:100%"><tr><td height="6" class="spacer" style="font-size:0pt; line-height:0pt; text-align:center; width:100%; min-width:100%">&nbsp;</td></tr></table>


																			<div class="text-footer-r" style="color:#a0a09a; font-family:'Google Sans', sans-serif; font-size:12px; line-height:16px; text-align:right">
																				Phone: <a href="tel:{{ config('app.info.phone') }}" target="_blank" class="link-grey" style="color:#8b8a84; text-decoration:none"><span class="link-grey" style="color:#8b8a84; text-decoration:none">{{ config('app.info.phone') }}</span></a>
																			</div>
																			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="spacer" style="font-size:0pt; line-height:0pt; text-align:center; width:100%; min-width:100%"><tr><td height="10" class="spacer" style="font-size:0pt; line-height:0pt; text-align:center; width:100%; min-width:100%">&nbsp;</td></tr></table>
